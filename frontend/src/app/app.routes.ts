...
import { loginGuard, authApplicantGuard, careersGuard } from './core/guards/auth.guard';
...
export const routes: Routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'applicant', component: DashboardComponent, canActivate: [authApplicantGuard] },
      { path: 'profile', component: ProfileComponent, canActivate: [authApplicantGuard] },
      {
        path: 'login',
        component: LoginComponent,
