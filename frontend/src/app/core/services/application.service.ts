...
export class ApplicationService {
  ...
  getAll(filters: ApplicationFilters = {}): Observable<ApiResponse<PaginatedResponse<Application>>> {
    ...
    return this.http.get<ApiResponse<PaginatedResponse<Application>>>(this.base, { params });
  }
  ...
  changeStatus(id: string, status: ApplicationStatus): Observable<ApiResponse<Application>> {
    ...
    return this.http.post<ApiResponse<Application>>(`${this.base}/change-status`, {}, { params });
  }

  calculateAiScore(id: string): Observable<ApiResponse<any>> {
    return this.http.post<ApiResponse<any>>(`${environment.apiUrl}/application/${id}/ai-score`, {});
  }
}
