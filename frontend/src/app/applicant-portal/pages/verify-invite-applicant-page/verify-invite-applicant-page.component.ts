...
@Component({
  selector: 'app-verify-invite-applicant-page',
  imports: [],
  templateUrl: './verify-invite-applicant-page.component.html',
  styleUrl: './verify-invite-applicant-page.component.scss',
})
export class VerifyInviteApplicantPageComponent {
    ...
    authService.verifyEmail(this.token).subscribe({
      next: (res) => {
        ...
        this.description.set(
          'Your invite has been confirmed. Create your initial password to finish activating the account.',
        );
