...
export class AdminUserService {
  ...
  getAll(
  ...
  ): Observable<ApiResponse<PaginatedResponse<UserAccount>>> {
    ...
    return this.http.get<ApiResponse<PaginatedResponse<UserAccount>>>(
      this.base,
      { params },
    );
  }
  ...
  resendTemporaryPassword(userId: string): Observable<ApiResponse<void>> {
    return this.http.post<ApiResponse<void>>(
      `${this.base}/${userId}/resend-credentials`,
      {},
    );
  }
}
