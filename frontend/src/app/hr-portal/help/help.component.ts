    ...
    <div class="page-container">
      <div class="page-header">
        <div>
          ...
          <p class="page-subtitle">
            Quick guidance for HR users working with vacancies, applicants, and
            interviews.
          </p>
        </div>
      </div>
      ...
      <div class="help-grid">
        ...
        <section class="card help-card">
          ...
          <ul class="help-list">
            <li>
              Create applicants manually if they are not self-registered yet.
            </li>
            <li>
              Review AI-parsed CV data before attaching an applicant to a
              vacancy.
            </li>
            <li>
              Applicants marked Hired or Banned cannot be attached to new
              vacancies.
            </li>
          </ul>
        </section>
        ...
        <section class="card help-card">
          ...
          <ul class="help-list">
            ...
            <li>
              Track candidate status directly from the Applicant-Vacancy record.
            </li>
            <li>
              Use the Application record to schedule interviews and review AI CV
              data.
            </li>
          </ul>
        </section>
        ...
        <section class="card help-card">
          ...
          <ul class="help-list">
            ...
            <li>
              Preview interviewer availability before saving the interview.
            </li>
